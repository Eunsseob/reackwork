    ...
    return (
        <div className={fade2}>
                ...
                <Row className='gap'>
                    ...
                    <Col>
                        ...
                        <Button variant="info" onClick={()=>{
                            ...
                            axios.post('http://localhost:8080/react/addCart', {id:findId.id, title:findId.title, count:1,
                                memId : user.email
                            })
                                .then((result) => {
                                    console.log(result);
            ...
            <Nav variant="tabs" defaultActiveKey="/home">
                <Nav.Item>
                    <Nav.Link onClick={()=>{setTab(0)}}>렌더링1</Nav.Link>
                </Nav.Item>
                <Nav.Item>
                    <Nav.Link onClick={()=>{setTab(1)}}>렌더링2</Nav.Link>
                </Nav.Item>
                <Nav.Item>
                    <Nav.Link onClick={()=>{setTab(2)}}>렌더링3</Nav.Link>
                </Nav.Item>
            </Nav>
            <TabContent tab={tab}/>
